...
outbreak.dataset <- outbreakteachR::outbreak_dataset_read(
    xlsx.file = system.file("extdata","2016_solutions_final.xlsx",
...
output in a new tab please click [\textcolor{blue}{here}](https://cdn.rawgit.com/OJWatson/outbreakteachR/master/tutorials/Animated-Network-Dynamic.html).
